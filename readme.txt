=== WP Estate Agency ===
Contributors: hexadecaedre
Developer: Sébastien T (contact@hexadecaedre.com)
 ...
 * energy consumption,
 * gas emissions.
* Property fields are set in a php file so **you must have a minimum of knowledge in php** (see /wp-content/plugins/wp-ea/default-data.php)

You need a gateway with your real estate software? Contact us: [full stack dev](https://dev.hexadecaedre.com)

== Installation ==
1. Unzip the plugin and upload the "wp-ea" folder to your "/wp-content/plugins/" directory
